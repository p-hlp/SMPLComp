...
class SMPLCompLookAndFeel : public LookAndFeel_V4
{
private:
	//Vars
...
public:
	...
	void drawBubble(Graphics& g, BubbleComponent& b, const juce::Point<float>& tip, const Rectangle<float>& body) override
	{
